...
//        IDCUtils.debug("IDCCalendr.isSameDay(): day1 = " + day1 + " / " + displayTimeDate(day1) + " / start = " + start1);
//        IDCUtils.debug("IDCCalendr.isSameDay(): day2 = " + day2 + " / " + displayTimeDate(day2) + " / start = " + start2);
