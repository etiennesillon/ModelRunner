...
// Following field definitions: display name, type and XML attribute name (must match the name in MetaModel.xml)
...
const APPLICATION_FIELDS = [
   ...
   [],
    ...
    [
      ...
      ["Explorer Formula Filter", STRING, "explorerFormulaFilter"],
